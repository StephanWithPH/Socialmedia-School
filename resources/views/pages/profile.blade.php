...
@section('body')
    <div class="img-fluid w-100 vertical-center text-md-left text-center" style="background-image: url('{{ asset('img/banner-home.jpg') }}'); height: 20vh">
        <div class="container position-relative" style="top:10vh">
            <div class="row">
                <div class="col">
                    <h1 class="display-4 text-white font-weight-bold"><img src="@if( $userProfile->avatar ){{action('ProfileController@loadProfileAvatar', $userProfile->id)}}@else{{asset('img/default-avatar.png')}}@endif" class="rounded-circle border bg-white" height="200px" width="200px" style="object-fit: cover;"/></h1>
                </div>
            </div>
        </div>
    </div>
